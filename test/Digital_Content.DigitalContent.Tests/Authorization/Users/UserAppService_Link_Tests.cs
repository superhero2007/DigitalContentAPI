...
namespace Digital_Content.DigitalContent.Tests.Authorization.Users
{
    public class UserAppService_Link_Tests : UserAppServiceTestBase
    {
        ...
        public UserAppService_Link_Tests()
        {
            ...
            _userManager = Resolve<IUserManager>();
        ...
        private async Task<int> CreateTestTenantAndTestUser()
        {
            ...
            {
                ConnectionString = SimpleStringCipher.Instance.Encrypt("Server=localhost; Database=DigitalContentTest_" + Guid.NewGuid().ToString("N") + "; Trusted_Connection=True;")
            };
