...
using Digital_Content.DigitalContent.Net.MimeTypes;
using OfficeOpenXml;

namespace Digital_Content.DigitalContent.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : DigitalContentServiceBase, ITransientDependency
    {
