...
using Digital_Content.DigitalContent.Authorization.Users.Profile.Cache;
using Digital_Content.DigitalContent.Authorization.Users.Profile.Dto;
using Digital_Content.DigitalContent.Friendships;
using Digital_Content.DigitalContent.Identity;
using Digital_Content.DigitalContent.Security;
using Digital_Content.DigitalContent.Storage;
using Digital_Content.DigitalContent.Timing;

namespace Digital_Content.DigitalContent.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : DigitalContentAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Digital_Content.DigitalContent",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Digital_Content.DigitalContent",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
