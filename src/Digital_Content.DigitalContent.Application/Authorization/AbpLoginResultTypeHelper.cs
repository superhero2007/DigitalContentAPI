...
{
    public class AbpLoginResultTypeHelper : DigitalContentServiceBase, ITransientDependency
    {
        public Exception CreateExceptionForFailedLoginAttempt(AbpLoginResultType result, string usernameOrEmailAddress, string tenancyName)
        {
            switch (result)
            {
                ...
                case AbpLoginResultType.InvalidUserNameOrEmailAddress:
                    return new UserFriendlyException(L("LoginFailed"), L("InvalidUserNameOrPassword")+ " or Tenant please clean your cache");
