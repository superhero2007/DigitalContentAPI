...
namespace Digital_Content.DigitalContent.Migrations
{
    ...
    [Migration("20171009135005_Add_Constraint_CreditCardUserId_Migration")]
    partial class Add_Constraint_CreditCardUserId_Migration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Digital_Content.DigitalContent.Wallets.WalletLogs", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Digital_Content.DigitalContent.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("Digital_Content.DigitalContent.CreditCardPayments.CreditCardPayment", "CreditCardPayment")
                        .WithMany("Users")
