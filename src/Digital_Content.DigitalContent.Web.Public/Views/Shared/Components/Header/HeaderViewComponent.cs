...
using Digital_Content.DigitalContent.Web.Public.Startup;
using Digital_Content.DigitalContent.Web.Session;

namespace Digital_Content.DigitalContent.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : DigitalContentViewComponent
    {
