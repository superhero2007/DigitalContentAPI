...
namespace Digital_Content.DigitalContent.Web.Public.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<DigitalContentWebFrontEndModule>(options =>
            {
...
//Integrate to OWIN
        ...
        private static void ConfigureOwinServices(IAppBuilder app)
        {
            ...
            //Enable it to use HangFire dashboard (uncomment only if it's enabled in DigitalContentWebCoreModule)
