...
using Digital_Content.DigitalContent.Web.Configuration;
#if FEATURE_SIGNALR
...
namespace Digital_Content.DigitalContent.Web
{
    ...
    public class DigitalContentWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DigitalContentWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(DigitalContentApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DigitalContentWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(DigitalContentWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
