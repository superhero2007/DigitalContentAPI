...
namespace Digital_Content.DigitalContent.Web.Security.Recaptcha
{
    public class RecaptchaValidator : DigitalContentServiceBase, IRecaptchaValidator, ITransientDependency
    {
