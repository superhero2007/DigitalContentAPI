...
namespace Digital_Content.DigitalContent.Authorization.Impersonation
{
    public class ImpersonationManager : DigitalContentDomainServiceBase, IImpersonationManager
    {
