...
using Digital_Content.DigitalContent.MultiTenancy.Demo;
...
namespace Digital_Content.DigitalContent.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(DigitalContentConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
