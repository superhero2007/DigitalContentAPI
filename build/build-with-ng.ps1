...
$webHostFolder = Join-Path $slnFolder "src/Digital_Content.DigitalContent.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/Digital_Content.DigitalContent.Web.Public"
